...
export default {
  ...
  mounted() {
    ...
    this.axios(
      "http://api.kele8.cn/agent/http://39.97.33.178/api/movieComingList?cityId=" + this.$store.state.city.id
    ).then(res => {
      console.log(res.data.data.comingList);
      this.playList = res.data.data.comingList;
